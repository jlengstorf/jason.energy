...
## Not shipping has high emotional and business costs.

Every company has its list of "we should" and "what if" ideas. Growing companies often end up with the ideas on this list collecting dust because there's *so much to do* that [squishy projects](https://www.jason.af/squishy-projects) get pushed back indefinitely in favor of more concrete, immediate needs.

This puts the fires out, but it leaves the company in a reactive pattern. This is high stress and can be demotivating, especially if the teams doing the firefighting wish they had the time to experiment. And even if you're trying to be a pragmatic BossBot™ about it, we can draw a clear connection between stress and demotivation to high churn and low productivity.

No one wants this. So what can we do to avoid this outcome?

## Protect time to create dual project streams.

Carving out and protecting time for teams to work on squishy ideas is critical for businesses to keep stay innovative and motivated. This time can be broken up in a number of ways:

- quarterly hackathons
- every 4th sprint is dedicated squishy projects
- one day a week

In a perfect world, teams will be able to keep parallel work streams going: one dedicated to the well-defined, urgent, load-bearing projects, and one dedicated to exploring and pursuing the "what ifs" and "we shoulds".
...
Just... please just ship it. Stop thinking about it. Ship. For the love of god.
...
Once your team has enough research to make a decision, delete. If the experiment is a success, the deleted code can be added to the todo item in the production queue for reference.
...
Even without these benefits, teams that have the autonomy to try things and influence the company's decision-making tend to feel more in control of their careers, which has the wonderful side effect of making your company a place that people *enjoy* working (for you BossBots™ that means higher engagement and productivity as well as lower churn).
...
Anyways. Go build awesome stuff. kthxbai
