...
<FnText id="backstory">
  I first started developing The Big Idea™ in 2019. When I worked at Netlify as an individual contributor, I made the pitch to my leadership team, but I couldn't manage to get it prioritized. When I was promoted to VP at Netlify in 2021, I redoubled my efforts but didn't manage to survive The Spreadsheet. Two years later [I went full-time on video production](https://codetv.dev/blog/full-time-learn-with-jason) and started pitching The Big Idea™ to partners across the tech industry — but I still couldn't get anyone to see what I saw (or, at least, not well enough to make it into the budget).
</FnText>
