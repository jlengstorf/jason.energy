...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744524803/jason.energy/v2/blog/2019-q1-retrospective/beers-at-beer.jpg
  alt: a group of people at Beer in Portland, OR
---
...
2.  **Publish two articles per month.** (Status: 😕)
    ...
    I wrote two blogs on my main blog, one on my [code blog](https://codetv.link/lwj), and a few on the [Gatsby blog](https://www.gatsbyjs.org/contributors/jason-lengstorf/). This doesn’t quite average out to two per month. However, I _did_ end up starting a [weekly livestream](https://twitch.tv/jlengstorf) that I’ve been really consistent with, so I feel pretty good about the amount of content I’ve been creating.
...
3.  **Do at least two community events per month.** (Status: ✅)
    ...
    I had no problem hitting this goal because I absolutely love doing these <Fn id="beers">community events.</Fn> Between local meetups and hosting a rotating dinner party series with friends, I’ve had no problem keeping my calendar full of great community events.
...
>
  ![Portland friends at a Beers at Beer event.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744524803/jason.energy/v2/blog/2019-q1-retrospective/beers-at-beer.jpg)
</Figure>
...
When I started at Gatsby, I installed Slack on my phone again. I left the notifications on, despite knowing better, because <Fn id="lies">Gatsby is an early stage startup and things are volatile.</Fn>
...
<Figure
  ...
  credit="Jason Lengstorf"
>
  ![Marisa with her bike.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744524803/jason.energy/v2/blog/2019-q1-retrospective/bike.jpg)
</Figure>
