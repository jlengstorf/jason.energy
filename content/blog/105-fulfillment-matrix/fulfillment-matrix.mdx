...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744515651/jason.energy/v2/blog/career-fulfillment-matrix/career-fulfillment.jpg
  alt: A 4-square matrix with the caption, "use this exercise to map a path to fulfillment in your career". The top-right has a blue section, and a hand-drawn arrow points to it with a speech bubble that reads, "Ideally, most of our daily tasks fall in the blue zone"
---
...
In stark contrast to this, I am decidedly terrible at video effects, but I get a deep sense of fulfillment out of making something work for [my livestream](https://codetv.link/lwj). It takes me far too long and I get a subpar result compared to what a professional VFX artist could do, but the struggle and my janky results give me a _huge_ sense of satisfaction.
...
<Figure credit="Jason Lengstorf">
  ![illustration of the matrix as described in the post](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744515651/jason.energy/v2/blog/career-fulfillment-matrix/job-fulfillment-matrix.jpg)
</Figure>
