...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744234069/jason.energy/v2/blog/context-switching/context-switching-time-loss-v2.jpg
  alt: a series of line charts showing time spent on projects vs. context switching, with the single task putting all time on projects, and 20% lost to context switching for each additional project. the final bar shows 5 simultaneous projects with 80% time loss to context switching
---
...
<Fn id="multitasking">Multitasking in action is a disaster.</Fn>

<FnText id="multitasking">
...
<Figure
  ...
  creditLink="https://jason.energy/context-switching"
>
  ![A timeline showing parallel tasks vs. sequential tasks. The parallel tasks are roughly twice as slow to deliver the first result as well as complete all projects.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744234070/jason.energy/v2/blog/context-switching/context-switching-timeline-comparison.jpg)
</Figure>
...
Combat this by <Fn id="interval">choosing an interval that works for you</Fn>, set a timer, and close everything unrelated to your task for that full working block.
