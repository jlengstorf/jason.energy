...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744521762/jason.energy/v2/blog/2019-retrospective/cheers.jpg
  alt: close-up of various cocktails held in hands as a group clinks glasses together
---
...
>
  ![Six drinks raised in the middle of tables in a toast.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744521762/jason.energy/v2/blog/2019-retrospective/cheers.jpg)
</Figure>
...
Over the last year I've taken salsa dancing lessons, <Fn id="shed">built a shed,</Fn> decorated our house, and became regulars at a few local businesses.
...
In addition to writing, I also created a bunch of code-related video content on _[Learn With Jason](https://codetv.link/lwj)_, [egghead](https://egghead.io/instructors/jason-lengstorf), and [Frontend Masters](https://frontendmasters.com/teachers/jason-lengstorf/).
...
I also doubled down on _[Learn With Jason](https://codetv.link/lwj)_, which has felt like the right format. It combines all the things I like: learning, teaching, interacting with the community, and talking through approaches with smart people.
...
I started [taking music lessons](https://codetv.dev/series/learn-with-jason/s2/make-a-beat-logic-pro-x), but I didn't make time for music as often as I wanted to.
