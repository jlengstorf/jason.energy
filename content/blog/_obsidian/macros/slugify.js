...
module.exports = {
  entry: async function ({ app }, settings) {
    const currentFile = Object.assign({}, app.workspace.getActiveFile());
    ...
    if (type === 'File') {
      ...
      await app.fileManager.renameFile(currentFile, slugified);
    } else if (type === 'Folder') {
      ...
      const slug = d + '-' + slugify(folderName);
      ...
      await app.vault.delete(currentFile.parent, true);
    }
  },
  settings: {
    name: 'Slugify',
