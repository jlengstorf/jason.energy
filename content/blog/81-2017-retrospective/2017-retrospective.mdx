...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527636/jason.energy/v2/blog/2017-retrospective/speaking.jpg
  alt: Jason Lengstorf on stage at GraphQL Summit.
---
...
<Figure
  ...
  credit="Ewen Roberts"
>
  ![The end is nigh.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527632/jason.energy/v2/blog/2017-retrospective/the-end-is-nigh.jpg)
</Figure>
...
As we roll into a new year, I want to continue a tradition I’ve [stolen from Nate](https://nategreen.org/2017-personal-retrospective/) and <Fn id="retro">write up a retrospective</Fn> on 2017.
...
So I moved to Austin, started <Fn id="commute">working from an office a few days a week,</Fn> and joined a team of 12 developers.
...
I spent a lot of time this year learning how to present, how to package ideas, <Fn id="framing">how to frame things to get the best response,</Fn> and how not to [set the building on fire](https://www.youtube.com/watch?v=tj0xtdN0_tA) when I didn’t immediately get my way.
...
In 2016, I didn’t do much speaking. Partially because I was [gallivanting around the world](https://lengstorf.com/two-years-in-airbnbs), but also because I just <Fn id="exciting">didn’t feel like I was working on anything exciting enough to speak about.</Fn>
...
<Figure
  ...
  credit="Orange"
>
  ![Jason Lengstorf at the 2017 GraphQL Summit.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527636/jason.energy/v2/blog/2017-retrospective/speaking.jpg)
</Figure>
...
<Figure
  ...
  credit="GrAMPS"
>
  ![GrAMPS logo.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527634/jason.energy/v2/blog/2017-retrospective/gramps.jpg)
</Figure>
...
I’ll spare you all the <Fn id="nerds">nerdy details,</Fn> but it’s called GrAMPS, which deeply satisfies my love of punny names. Since releasing it, I’ve had developers from companies like Target, the New York Times, and the NHL look into it as a solution for their large-scale projects.
...
>
  ![Collage of meals Marisa and Jason cooked together.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527635/jason.energy/v2/blog/2017-retrospective/cooking.jpg)
</Figure>
...
<blockquote class="twitter-tweet" data-lang="en">
  ...
  &mdash; Jason Lengstorf (@jlengstorf) <a href="https://twitter.com/jlengstorf/status/943383326592602112?ref_src=twsrc%5Etfw">December 20, 2017</a>
</blockquote><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
It turns out that we _really_ enjoy cooking. And we’re not half bad at it. In fact, if I can toot my own horn for a minute, we’ve got a few meals that <Fn id="steak">we make better than most restaurants.</Fn>
...
<Figure
  ...
  credit="Nabeel Syed"
>
  ![Traffic jam.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744527638/jason.energy/v2/blog/2017-retrospective/commute.jpg)
</Figure>

But there were a few downsides; most notably, **I have a fucking commute now.**

Not every day, but at least two days a week <Fn id="car">I have to drive</Fn> 45 minutes _each way_ to my office.[^car] This isn’t the worst commute I’ve heard of by a long shot, but my previous commute was a thirty-second walk to my couch — I really felt the pain of losing 90 minutes a day to sitting in a car.
...
That time cut into my mornings and had a domino effect that I really dislike: I had to start setting an alarm, had to make a <Fn id="gym">choice between writing and hitting the gym,</Fn> and had to choose between coffee and breakfast.
