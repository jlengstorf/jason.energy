...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744233690/jason.energy/v2/blog/buffalo-stick/buffalo-stick.jpg
  alt: a collage style card featuring two buffalo with a stick that appears to be scratching their backs. the text overlaid reads, "the buffalo stick. how great devrels turn 1 content piece into 10+"
---
...
Back when she was my boss at Netlify, [Sarah Drasner](https://twitter.com/sarah_edo) developed a reputation for <Fn id="bloops">coming up with funny gibberish descriptions of things that would become canon for our team.</Fn>
...
>
  ![Two cutout images of buffalo with a stick badly photoshopped onto them. There are scritch sound effects and the caption "the buffalo stick"](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744233689/jason.energy/v2/blog/buffalo-stick/buffalo-stick-full.jpg)
</Figure>
...
I don't want to get too hyperbolic here, but multi-leveraging the effort to create one tutorial and turning it into more than 10 discrete, independently valuable artifacts feels like <Fn id="tenx">the very definition of a 10⨉ engineer.</Fn>
...
- He then showed up in the chat of my [follow-up livestream](https://codetv.dev/series/learn-with-jason/s5/lets-play-with-realtime-pt-2) to make sure I got everything running and help answer questions for people watching along
