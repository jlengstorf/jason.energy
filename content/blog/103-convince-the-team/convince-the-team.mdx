...
image:
  src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1744515948/jason.energy/v2/blog/convince-the-team/learn-fast-try-not-to-make-a-mess.jpg
  alt: Learn fast and try not to make a mess. There's a dumpster fire drawing and an arrow pointing to it that reads, "This doesn't have to be your code."
---
