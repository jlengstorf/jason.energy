...
image:
    src: https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1771185873/get-more-done-better-scheduling.jpg
...
<Figure>
  ![Rethink your schedule and get more done faster.](https://res.cloudinary.com/jlengstorf/image/upload/f_auto/q_auto/v1771185873/get-more-done-better-scheduling.jpg)
</Figure>
...
**Bullshit days are for all the things that are required for us to do our important tasks,** but that aren't necessarily the flashy parts of the job that we look forward to. This can include email, accounting, research, outlining, setting up development environments, or collecting inspiration for a new design.
